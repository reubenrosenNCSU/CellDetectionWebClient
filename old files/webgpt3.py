...
def upload_file():
    ...
    if file and allowed_file(file.filename):
        ...
        run_subprocess('python3', ['normalize.py'])
        run_subprocess('python3', ['splitimage.py', filepath])
        run_subprocess('python3', ['detection.py'])
        run_subprocess('python3', ['mergeimage.py'])
        run_subprocess('python3', ['readingcsv.py'])
