...
# Example usage
input_csv_dir = '/home/greenbaumgpu/Reuben/CellDetection/output/csv_output'  # Path to the folder containing your CSV files
output_csv_file = '/home/greenbaumgpu/Reuben/CellDetection/finaloutput/annotations.csv'  # Path for the output merged CSV file
